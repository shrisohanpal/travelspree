        ...
        <div>
                ...
                {window.innerWidth > 780 && (
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto ml-3">
                            ...
                            <LinkContainer to='/allpackages'>
                                <Nav.Link className="mx-3"><i className='fas fa-address-book' /> All Packages</Nav.Link>
                            </LinkContainer>
                        </Nav>
            ...
            <Drawer anchor='left' open={drawerOpen} onClose={() => { setDrawerOpen(false) }}>
                <List style={{ width: 250 }}>
                    ...
                    <ListItem>
                        <LinkContainer to='/allpackages'>
                            <Nav.Link><i className='fas fa-address-book' /> All Packages</Nav.Link>
                        </LinkContainer>
                    </ListItem>
                </List>
            </Drawer>
